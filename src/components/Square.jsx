    ...
    <>
      <div className="flex flex-col gap-2 px-3 pt-5 lg:px-9 lg:pt-8">
        ...
        <p className="text-slate-300 h-28 overflow-hidden text-sm lg:text-lg">
          ...
          ipsa tenetur perferendis dicta nisi ipsum dolor sit amet consectetur adipisicing elit. Eos quasi
          ipsa tenetur perferendis dicta nisi.
        </p>
        <button 
    ...
    <>
      <div className="flex flex-col gap-2 pl-2 lg:px-9 lg:pt-8">
        ...
        <p className="text-slate-300 text-sm lg:mt-6 lg:text-lg">
          ...
          explicabo, cumque facilis incidunt officia assumenda, magni iste
          ducimus eligendi ratione consequatur dolore nostrum officiis...
        </p>
      ...
      <div className="flex w-full text-4xl lg:text-6xl text-white">
        <button className="bg-bluewater w-full h-14 lg:h-28 flex items-center justify-center" onClick={()=>handleVote(true)}>
          <HiThumbUp />
        </button>
        <button className="bg-darkyellow w-full h-14 lg:h-28 flex items-center justify-center" onClick={()=>handleVote(false)}>
          <HiThumbDown />
        </button>
      </div>
    </>
